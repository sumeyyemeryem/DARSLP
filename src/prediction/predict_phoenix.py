"""
DARSLP Inference — PHOENIX-2014T
==================================
Runs inference with a trained DARSLPGenerator + DisentangledAE checkpoint on any
PHOENIX-2014T split (train / dev / test) and saves the results as a .pt file.
...
Pose layout (178 joints):
    ...
    2     right wrist   (restored from right-hand wrist at index 6)
    3–4   upper body (continued)
    5     left wrist    (restored from left-hand wrist at index 27)
...
For back-translation evaluation use export_phoenix.py instead (outputs .npz).

Usage:
    python src/prediction/predict_phoenix.py \\
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output",          default=r"predictions\predictions_phoenix_test.pt")
